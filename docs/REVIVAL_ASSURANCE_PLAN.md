...
- **Implemented (2026-09-11):**
  ...
  - **Dry-run plan against the real rig** (`In operation/Flu-X-rc8-runtime`, real install's `mods/` as
...
- **Acceptance:** re-packaging SEEKER reproduces today's `Done/SEEKER-0.98a.zip` layout.
